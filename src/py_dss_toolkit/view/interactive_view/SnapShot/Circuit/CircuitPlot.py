...
class CircuitPlot(CircuitBase):
    ...
    def circuit_plot(
        ...
        if numerical_plot:
            self._add_numerical_plot_traces(
                fig,
                settings,
                results,
                hovertemplate,
            ...
            self._add_categorical_plot_traces(
                fig,
                settings,
                result_values,
                hovertemplate,
    ...
    def _add_numerical_plot_traces(
        self,
        fig,
        settings,
        results,
        ...
        for connection, color, value in zip(connections, colors, result_values):
            ...
            customdata = [[element, bus1, bus2, result_value], [element, bus1, bus2, result_value]]
            ...
            fig.add_trace(
                go.Scatter(
                    ...
                    line=dict(
                        ...
                        dash=self._get_dash(
                            element, num_phases, dash_1ph, dash_2ph, dash_3ph, line_type, dash_oh, dash_ug
                        ),
                    ),
                    showlegend=False,
                    name="",
    ...
    def _add_categorical_plot_traces(
        self,
        fig,
        settings,
        result_values,
        ...
        fig.update_layout(showlegend=True, legend=dict(x=1.2, y=1, traceorder="normal"))
